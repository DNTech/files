...
if (!/wordpress|facebook/.test(params.PublishType))
...
// animation core
files.push({ 'src': 'common/js/wowslider.animate.js', dest: (params.PublishType == "wordpress"? scriptOut: wowsliderJs) });
...
if(params.FullScreen) {
	files.push({ 'src': 'common/js/nosleep.js', dest: (params.PublishType == "wordpress"? scriptOut: wowsliderJs) });
}
